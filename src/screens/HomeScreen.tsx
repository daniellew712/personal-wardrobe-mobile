    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={styles.card}>
          ...
          <Text style={styles.cardSubtitle}>Browse your wardrobe</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.card}>
          <Text style={styles.cardTitle}>Outfits</Text>
          <Text style={styles.cardSubtitle}>Create and save outfits</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.card}>
          <Text style={styles.cardTitle}>Add Item</Text>
          <Text style={styles.cardSubtitle}>Add new clothing items</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.card}>
          <Text style={styles.cardTitle}>Statistics</Text>
          <Text style={styles.cardSubtitle}>View wearing patterns</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
